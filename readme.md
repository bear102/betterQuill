...
<img src="https://github.com/bear102/betterQuill/blob/main/images/Screenshot%202023-05-26%20133724.png" alt="first" width="50%" height="50%" style="border: 1px solid black; width: 50%; height: 50%;">
</div>
...
<div style="border: 1px solid black; padding: 5px;">
<img src="https://github.com/bear102/betterQuill/blob/main/images/Screenshot%202023-05-26%20134058.png" alt="first" width="50%" height="50%" style="border: 1px solid black; width: 50%; height: 50%;">
</div>
...
<div style="border: 1px solid black; padding: 5px;">
<img src="https://github.com/bear102/betterQuill/blob/main/images/Screenshot%202023-05-26%20135000.png" alt="first" width="50%" height="50%" style="border: 1px solid black; width: 50%; height: 50%;">
</div>

by pressing **`ctrl + alt + u`** it gives you the correct passage with all the fixes highlighted:

<div style="border: 1px solid black; padding: 5px;">
<img src="https://github.com/bear102/betterQuill/blob/main/images/Screenshot%202023-05-26%20134910.png" alt="first" width="50%" height="50%" style="border: 1px solid black; width: 50%; height: 50%;">
</div>
